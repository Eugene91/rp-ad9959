# 0 "src/rp-ad9959-dds.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/rp-ad9959-dds.c"
...
# 24 "include/rp.h" 2
# 1 "/usr/lib/gcc/x86_64-pc-linux-gnu/12.2.1/include/stdbool.h" 1 3 4
# 25 "include/rp.h" 2
# 104 "include/rp.h"
...
typedef enum {
    RP_GEN_SWEEP_DIR_NORMAL,
    RP_GEN_SWEEP_DIR_UP_DOWN
} rp_gen_sweep_dir_t;

typedef enum {
    RP_GEN_SWEEP_MODE_LINEAR,
...
typedef struct {
 ...
 uint32_t magic;
    ...
    uint32_t low_filter_aa_ch1;
    uint32_t low_filter_bb_ch1;
    uint32_t low_filter_pp_ch1;
    uint32_t low_filter_kk_ch1;
    uint32_t low_filter_aa_ch2;
    uint32_t low_filter_bb_ch2;
    uint32_t low_filter_pp_ch2;
    uint32_t low_filter_kk_ch2;
    uint32_t hi_filter_aa_ch1;
    uint32_t hi_filter_bb_ch1;
    uint32_t hi_filter_pp_ch1;
    uint32_t hi_filter_kk_ch1;
    uint32_t hi_filter_aa_ch2;
    uint32_t hi_filter_bb_ch2;
    uint32_t hi_filter_pp_ch2;
    uint32_t hi_filter_kk_ch2;
...
# 401 "include/rp.h"
int rp_EnableDigitalLoop(
# 401 "include/rp.h" 3 4
                        _Bool 
# 401 "include/rp.h"
                             enable);
# 415 "include/rp.h"
...
# 755 "include/rp.h"
int rp_AcqSetArmKeep(
# 755 "include/rp.h" 3 4
                    _Bool 
# 755 "include/rp.h"
                         enable);
...
int rp_AcqGetArmKeep(
# 763 "include/rp.h" 3 4
                    _Bool
# 763 "include/rp.h"
                        * state);
...
int rp_AcqGetBufferFillState(
# 771 "include/rp.h" 3 4
                            _Bool
# 771 "include/rp.h"
                                * state);
# 780 "include/rp.h"
...
# 855 "include/rp.h"
int rp_AcqSetAveraging(
# 855 "include/rp.h" 3 4
                      _Bool 
# 855 "include/rp.h"
                           enabled);
# 864 "include/rp.h"
int rp_AcqGetAveraging(
# 864 "include/rp.h" 3 4
                      _Bool 
# 864 "include/rp.h"
                           *enabled);
# 874 "include/rp.h"
...
# 1248 "include/rp.h"
int rp_GenOutIsEnabled(rp_channel_t channel, 
# 1248 "include/rp.h" 3 4
                                            _Bool 
# 1248 "include/rp.h"
                                                 *value);
# 1257 "include/rp.h"
...
# 8 "src/rp-ad9959-dds.c" 2
# 1 "src/pins.c" 1

int unsigned MASTER_RESET=RP_DIO1_P;
int unsigned SDIO2 = RP_DIO1_N;
int unsigned SDIO3 = RP_DIO2_P;
int unsigned SDIO1 = RP_DIO2_N;
int unsigned SDIO0 = RP_DIO3_P;
int unsigned SCLK = RP_DIO3_N;
int unsigned CS = RP_DIO4_P;
int unsigned DINP0 = RP_DIO4_N;
int unsigned DINP1 = RP_DIO5_P;
int unsigned DINP2 = RP_DIO5_N;
int unsigned DINP3 = RP_DIO6_P;
int unsigned IOUPDATE = RP_DIO6_N;
const unsigned long int SYS_FREQ =25*1000000*20;
# 9 "src/rp-ad9959-dds.c" 2
...
void write_CFTW0(unsigned long int F_word)
{
...
void add9959 (int freq, int ch) {
    ...
    if (rp_Init() != 0) {
        fprintf(
# 137 "src/rp-ad9959-dds.c" 3 4
               stderr
# 137 "src/rp-ad9959-dds.c"
                     , "Red Pitaya API init failed!\n");
        return 
# 138 "src/rp-ad9959-dds.c" 3 4
              1
# 138 "src/rp-ad9959-dds.c"
                          ;
    }
    ...
    return 
# 169 "src/rp-ad9959-dds.c" 3 4
          0
# 169 "src/rp-ad9959-dds.c"
                      ;
}
...
int main(int argc, char** argv)
{
    ...
    static int freq = 10000000;
    static int ch = 0;

    int exitCode = 
# 186 "src/rp-ad9959-dds.c" 3 4
                  0
# 186 "src/rp-ad9959-dds.c"
                              ;
    ...
    dropt_option options[] = {
        { 'h', "help", "Shows help.", 
# 191 "src/rp-ad9959-dds.c" 3 4
                                      ((void *)0)
# 191 "src/rp-ad9959-dds.c"
                                          , dropt_handle_bool, &showHelp, dropt_attr_halt },
        { '?', 
# 192 "src/rp-ad9959-dds.c" 3 4
              ((void *)0)
# 192 "src/rp-ad9959-dds.c"
                  , 
# 192 "src/rp-ad9959-dds.c" 3 4
                    ((void *)0)
# 192 "src/rp-ad9959-dds.c"
...
# 192 "src/rp-ad9959-dds.c" 3 4
                          ((void *)0)
# 192 "src/rp-ad9959-dds.c"
                              , dropt_handle_bool, &showHelp, dropt_attr_halt | dropt_attr_hidden },
    ...
    if (droptContext == 
# 200 "src/rp-ad9959-dds.c" 3 4
                       ((void *)0)
# 200 "src/rp-ad9959-dds.c"
                           )
    {
        ...
        exitCode = 
# 208 "src/rp-ad9959-dds.c" 3 4
                  1
# 208 "src/rp-ad9959-dds.c"
                              ;
    }
    else if (argc == 0)
    {
    ...
    else
    {
        ...
        {
            fprintf(
# 225 "src/rp-ad9959-dds.c" 3 4
                   stderr
# 225 "src/rp-ad9959-dds.c"
                         , "add9959-dds-firmware: %s\n", dropt_get_error_message(droptContext));
            exitCode = 
# 226 "src/rp-ad9959-dds.c" 3 4
                      1
# 226 "src/rp-ad9959-dds.c"
                                  ;
        }
        else if (showHelp)
        {
            printf("Usage: add9959-dds-firmware [options] [--] [operands]\n\n"
                   "Options:\n");
            dropt_print_help(
# 232 "src/rp-ad9959-dds.c" 3 4
                            stdout
# 232 "src/rp-ad9959-dds.c"
                                  , droptContext, 
# 232 "src/rp-ad9959-dds.c" 3 4
                                                  ((void *)0)
# 232 "src/rp-ad9959-dds.c"
        ...
        else
        {
            if (freq > 200000000 || freq <= 0 || ch >3 || ch <0)
            {
               ...
               return 
# 239 "src/rp-ad9959-dds.c" 3 4
                     1
# 239 "src/rp-ad9959-dds.c"
                                 ;
